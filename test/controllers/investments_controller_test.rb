...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference("Investment.count") do
      post investments_url, params: { investment: { assigned_to_id: @investment.assigned_to_id, assigned_to_type: @investment.assigned_to_type, portfolio_id: @investment.portfolio_id } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { assigned_to_id: @investment.assigned_to_id, assigned_to_type: @investment.assigned_to_type, portfolio_id: @investment.portfolio_id } }
