...
class InvestmentsTest < ApplicationSystemTestCase
  ...
  test "should create investment" do
    ...
    fill_in "Assigned to", with: @investment.assigned_to_id
    fill_in "Assigned to type", with: @investment.assigned_to_type
    fill_in "Portfolio", with: @investment.portfolio_id
